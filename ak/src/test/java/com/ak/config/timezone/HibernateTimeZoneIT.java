package com.ak.config.timezone;

import com.ak.AkApp;
import com.ak.repository.timezone.DateTimeWrapper;
import com.ak.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM true_date_time_wrapper where id=%d", fieldName, id);
    }
