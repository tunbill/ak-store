...
public class CompanyResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "E@?.2";
    private static final String UPDATED_EMAIL = "Xg@u.O";
    ...
    @Test
    @Transactional
    public void getAllCompaniesByCustomerTypeIsEqualToSomething() throws Exception {
        // Initialize the database
        companyRepository.saveAndFlush(company);
        CustomerType customerType = CustomerTypeResourceIT.createEntity(em);
        em.persist(customerType);
        em.flush();
        company.addCustomerType(customerType);
        companyRepository.saveAndFlush(company);
        Long customerTypeId = customerType.getId();

        // Get all the companyList where customerType equals to customerTypeId
        defaultCompanyShouldBeFound("customerTypeId.equals=" + customerTypeId);

        // Get all the companyList where customerType equals to customerTypeId + 1
        defaultCompanyShouldNotBeFound("customerTypeId.equals=" + (customerTypeId + 1));
    }
    ...
    @Test
    @Transactional
    public void getAllCompaniesByStoreIsEqualToSomething() throws Exception {
        // Initialize the database
        companyRepository.saveAndFlush(company);
        ...
        // Get all the companyList where store equals to storeId
        defaultCompanyShouldBeFound("storeId.equals=" + storeId);

        // Get all the companyList where store equals to storeId + 1
        defaultCompanyShouldNotBeFound("storeId.equals=" + (storeId + 1));
    }


    @Test
    @Transactional
    public void getAllCompaniesByDepartmentIsEqualToSomething() throws Exception {
        // Initialize the database
        companyRepository.saveAndFlush(company);
        ...
        // Get all the companyList where department equals to departmentId
        defaultCompanyShouldBeFound("departmentId.equals=" + departmentId);

        // Get all the companyList where department equals to departmentId + 1
        defaultCompanyShouldNotBeFound("departmentId.equals=" + (departmentId + 1));
    }


    @Test
    @Transactional
    public void getAllCompaniesByJobsIsEqualToSomething() throws Exception {
        // Initialize the database
        companyRepository.saveAndFlush(company);
        Jobs jobs = JobsResourceIT.createEntity(em);
        em.persist(jobs);
        em.flush();
        ...
        // Get all the companyList where jobs equals to jobsId
        defaultCompanyShouldBeFound("jobsId.equals=" + jobsId);

        // Get all the companyList where jobs equals to jobsId + 1
        defaultCompanyShouldNotBeFound("jobsId.equals=" + (jobsId + 1));
    }


    @Test
    @Transactional
    public void getAllCompaniesByJobTypeIsEqualToSomething() throws Exception {
        // Initialize the database
        companyRepository.saveAndFlush(company);
        JobType jobType = JobTypeResourceIT.createEntity(em);
        em.persist(jobType);
        em.flush();
        company.addJobType(jobType);
        companyRepository.saveAndFlush(company);
        Long jobTypeId = jobType.getId();

        // Get all the companyList where jobType equals to jobTypeId
        defaultCompanyShouldBeFound("jobTypeId.equals=" + jobTypeId);

        // Get all the companyList where jobType equals to jobTypeId + 1
        defaultCompanyShouldNotBeFound("jobTypeId.equals=" + (jobTypeId + 1));
    }
    ...
    @Test
    @Transactional
    public void getAllCompaniesByItemIsEqualToSomething() throws Exception {
        // Initialize the database
        companyRepository.saveAndFlush(company);
        ...
        // Get all the companyList where item equals to itemId
        defaultCompanyShouldBeFound("itemId.equals=" + itemId);

        // Get all the companyList where item equals to itemId + 1
        defaultCompanyShouldNotBeFound("itemId.equals=" + (itemId + 1));
    }


    @Test
    @Transactional
    public void getAllCompaniesByItemGroupIsEqualToSomething() throws Exception {
        // Initialize the database
        companyRepository.saveAndFlush(company);
        ItemGroup itemGroup = ItemGroupResourceIT.createEntity(em);
        em.persist(itemGroup);
        em.flush();
        company.addItemGroup(itemGroup);
        companyRepository.saveAndFlush(company);
        Long itemGroupId = itemGroup.getId();

        // Get all the companyList where itemGroup equals to itemGroupId
        defaultCompanyShouldBeFound("itemGroupId.equals=" + itemGroupId);

        // Get all the companyList where itemGroup equals to itemGroupId + 1
        defaultCompanyShouldNotBeFound("itemGroupId.equals=" + (itemGroupId + 1));
    }


    @Test
    @Transactional
    public void getAllCompaniesByUnitIsEqualToSomething() throws Exception {
        // Initialize the database
        companyRepository.saveAndFlush(company);
        ...
        // Get all the companyList where unit equals to unitId
        defaultCompanyShouldBeFound("unitId.equals=" + unitId);

        // Get all the companyList where unit equals to unitId + 1
        defaultCompanyShouldNotBeFound("unitId.equals=" + (unitId + 1));
    }


    @Test
    @Transactional
    public void getAllCompaniesByInvoiceIsEqualToSomething() throws Exception {
        // Initialize the database
        companyRepository.saveAndFlush(company);
        ...
        // Get all the companyList where invoice equals to invoiceId
        defaultCompanyShouldBeFound("invoiceId.equals=" + invoiceId);

        // Get all the companyList where invoice equals to invoiceId + 1
        defaultCompanyShouldNotBeFound("invoiceId.equals=" + (invoiceId + 1));
    }


    @Test
    @Transactional
    public void getAllCompaniesByInvoiceLineIsEqualToSomething() throws Exception {
        // Initialize the database
        companyRepository.saveAndFlush(company);
        InvoiceLine invoiceLine = InvoiceLineResourceIT.createEntity(em);
        em.persist(invoiceLine);
        em.flush();
        company.addInvoiceLine(invoiceLine);
        companyRepository.saveAndFlush(company);
        Long invoiceLineId = invoiceLine.getId();

        // Get all the companyList where invoiceLine equals to invoiceLineId
        defaultCompanyShouldBeFound("invoiceLineId.equals=" + invoiceLineId);

        // Get all the companyList where invoiceLine equals to invoiceLineId + 1
        defaultCompanyShouldNotBeFound("invoiceLineId.equals=" + (invoiceLineId + 1));
    }
