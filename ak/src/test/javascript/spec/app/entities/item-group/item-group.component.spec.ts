...
import { ItemGroupComponent } from 'app/entities/item-group/item-group.component';
...
describe('Component Tests', () => {
  describe('ItemGroup Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.itemGroups[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
