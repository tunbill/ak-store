...
import { TermsComponent } from 'app/entities/terms/terms.component';
import { TermsService } from 'app/entities/terms/terms.service';
import { Terms } from 'app/shared/model/terms.model';

describe('Component Tests', () => {
  describe('Terms Management Component', () => {
    let comp: TermsComponent;
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.terms[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
