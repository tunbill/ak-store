...
export class UnitComponentsPage {
  ...
  deleteButtons = element.all(by.css('ak-unit div table .btn-danger'));
  title = element.all(by.css('ak-unit div h2#page-heading span')).first();
...
export class UnitUpdatePage {
  pageTitle = element(by.id('ak-unit-heading'));
...
export class UnitDeleteDialog {
  private dialogTitle = element(by.id('ak-delete-unit-heading'));
  private confirmButton = element(by.id('ak-confirm-delete-unit'));
